        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-2">
          <Card className="overflow-hidden">
            ...
            <div className="grid gap-5 p-5">
              ...
              <RangeField label="Размер скользящего окна GigaChat" value={form.gigachatContextRatio} onChange={(value) => setForm({ ...form, gigachatContextRatio: value })} preview={`${form.gigachatContextRatio * 100}% от ${gigachatLimit.toLocaleString("ru-RU")} = ${totalBudget.toLocaleString("ru-RU")} tokens`} />
          ...
          <Card className="overflow-hidden">
            ...
            <div className="grid gap-5 p-5">
              <RangeField label="Контекст Embeddings" value={form.embeddingContextRatio} onChange={(value) => setForm({ ...form, embeddingContextRatio: value })} preview={`${form.embeddingContextRatio * 100}% от ${embeddingLimit.toLocaleString("ru-RU")} = ${embeddingBudget.toLocaleString("ru-RU")} tokens`} />
